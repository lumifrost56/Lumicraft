...
void loadblocks() {
    ...
    std::vector<unsigned int> indices;
    std::vector<Texture> textures = {
        {1, "../resources/images/oaklogside.png"},
        {2, "../resources/images/oaklogtop.png"}
    };
    generateblock(vertices, indices, textures, {1, 1, 1, 1, 2, 2});
    Mesh oaklog(vertices, indices, textures, true);
