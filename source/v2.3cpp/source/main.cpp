...
void process_input(GLFWwindow *window) {
    ...
    if (pressed_w(window)) {
        player.process_keyboard(FORWARD, dt);
    }
    if (pressed_s(window)) {
        player.process_keyboard(BACKWARD, dt);
    }
    if (pressed_a(window)) {
        player.process_keyboard(LEFT, dt);
    }
    if (pressed_d(window)) {
        player.process_keyboard(RIGHT, dt);
    }
    if (pressed_space(window)) {
        player.process_keyboard(UP, dt);
    }
    if (pressed_left_shift(window)) {
        player.process_keyboard(DOWN, dt);
    }
